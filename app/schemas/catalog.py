...
class PanelSchema(BaseModel):
    ...
    max_series_fuse_a: Optional[float] = Field(default=None, gt=0, le=500)
...
class InverterSchema(BaseModel):
    ...
    mppt_v_min: Optional[float] = Field(default=None, ge=0, le=2000)
    mppt_v_max: Optional[float] = Field(default=None, ge=0, le=2000)
    mppt_count: Optional[int] = Field(default=None, ge=1, le=50)
    isc_max_per_mppt: Optional[float] = Field(default=None, ge=0, le=10000)
    y: Optional[float] = Field(default=None, ge=0, le=100)
    precio_unitario: Optional[float] = Field(default=None, ge=0, le=10_000_000)
    inflacion_pct: Optional[float] = Field(default=None, ge=0, le=100)
