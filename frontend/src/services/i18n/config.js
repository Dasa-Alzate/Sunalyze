...
const resources = {
  es: { nav: esNav, common: esCommon, auth: esAuth, settings: esSettings, errors: esErrors, notifications: esNotifications, activity: esActivity, trash: esTrash, templates: esTemplates, branding: esBranding, budget: esBudget, circuit: esCircuit, assist: esAssist },
  en: { nav: enNav, common: enCommon, auth: enAuth, settings: enSettings, errors: enErrors, notifications: enNotifications, activity: enActivity, trash: enTrash, templates: enTemplates, branding: enBranding, budget: enBudget, circuit: enCircuit, assist: enAssist },
}
...
if (!i18n.isInitialized) {
  i18n.use(initReactI18next).init({
    ...
    ns: ['nav', 'common', 'auth', 'settings', 'errors', 'notifications', 'activity', 'trash', 'templates', 'branding', 'budget', 'circuit', 'assist'],
    defaultNS: 'common',
